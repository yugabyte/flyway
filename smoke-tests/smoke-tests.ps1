...
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "migrate");
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "validate");
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "info");
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "clean");
...
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "info", "-pro");
& $flywayCmd @("-configFiles=smoke-tests\flyway.conf", "clean", "-pro");
